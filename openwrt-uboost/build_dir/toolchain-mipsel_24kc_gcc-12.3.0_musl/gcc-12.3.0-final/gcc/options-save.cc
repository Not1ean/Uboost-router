		      ...
		      struct gcc_options *opts_set)
{
  ...
  gcc_assert (IN_RANGE (opts->x_flag_frame_header_optimization, -128, 127));
  ...
  ptr->x_flag_frame_header_optimization = opts->x_flag_frame_header_optimization;
  ...
  if (opts_set->x_flag_frame_header_optimization) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_str_align_functions) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_str_align_jumps) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_str_align_labels) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_str_align_loops) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_patchable_function_entry) mask |= HOST_WIDE_INT_1U << 47;
			 ...
			 struct cl_optimization *ptr)
{
  ...
  opts->x_flag_frame_header_optimization = ptr->x_flag_frame_header_optimization;
  ...
  mask >>= 1;
  opts_set->x_flag_frame_header_optimization = (mask & 1) != 0;
  mask >>= 1;
                       ...
                       struct cl_optimization *ptr)
{
  ...
  if (ptr->x_flag_frame_header_optimization)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_frame_header_optimization",
             ptr->x_flag_frame_header_optimization);
                            ...
                            struct cl_optimization *ptr2)
{
  ...
  if (ptr1->x_flag_frame_header_optimization != ptr2->x_flag_frame_header_optimization)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_frame_header_optimization",
             ptr1->x_flag_frame_header_optimization,
             ptr2->x_flag_frame_header_optimization);
...
cl_target_option_save (struct cl_target_option *ptr, struct gcc_options *opts,
		       struct gcc_options *opts_set)
{
  gcc_assert (IN_RANGE (opts->x_mips_lra_flag, -128, 127));

  if (targetm.target_option.save)
    targetm.target_option.save (ptr, opts, opts_set);

  ptr->x_mips_lra_flag = opts->x_mips_lra_flag;

  unsigned HOST_WIDE_INT mask = 0;
  if (opts_set->x_mips_lra_flag) mask |= HOST_WIDE_INT_1U << 0;
  ptr->explicit_mask[0] = mask;
}
...
{
  opts->x_mips_lra_flag = ptr->x_mips_lra_flag;

  unsigned HOST_WIDE_INT mask;
  mask = ptr->explicit_mask[0];
  opts_set->x_mips_lra_flag = (mask & 1) != 0;
  mask >>= 1;
...
{
  fputs ("\n", file);
  if (ptr1->x_mips_lra_flag != ptr2->x_mips_lra_flag)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent, "",
             "mips_lra_flag",
             ptr1->x_mips_lra_flag,
             ptr2->x_mips_lra_flag);
...
{
  inchash::hash hstate;
  hstate.add_hwi (ptr->x_mips_lra_flag);
...
{
  bp_pack_value (bp, ptr->x_mips_lra_flag, 64);
  for (size_t i = 0; i < sizeof (ptr->explicit_mask) / sizeof (ptr->explicit_mask[0]); i++)
...
cl_target_option_stream_in (struct data_in *data_in ATTRIBUTE_UNUSED,
                            ...
                            struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ptr->x_mips_lra_flag = (signed char ) bp_unpack_value (bp, 64);
  for (size_t i = 0; i < sizeof (ptr->explicit_mask) / sizeof (ptr->explicit_mask[0]); i++)
...
cl_optimization_hash (struct cl_optimization const *ptr ATTRIBUTE_UNUSED)
{
  ...
  hstate.add_hwi (ptr->x_flag_frame_header_optimization);
  for (size_t i = 0; i < sizeof (ptr->explicit_mask) / sizeof (ptr->explicit_mask[0]); i++)
    hstate.add_hwi (ptr->explicit_mask[i]);
  return hstate.end ();
}
                            ...
                            struct cl_optimization *ptr)
{
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_frame_header_optimization);
  for (size_t i = 0; i < sizeof (ptr->explicit_mask) / sizeof (ptr->explicit_mask[0]); i++)
    bp_pack_value (bp, ptr->explicit_mask[i], 64);
}
                           ...
                           struct cl_optimization *ptr ATTRIBUTE_UNUSED)
{
  ...
  ptr->x_flag_frame_header_optimization = (signed char ) bp_unpack_var_len_int (bp);
  for (size_t i = 0; i < sizeof (ptr->explicit_mask) / sizeof (ptr->explicit_mask[0]); i++)
    ptr->explicit_mask[i] = bp_unpack_value (bp, 64);
}
...
cl_optimization_compare (gcc_options *ptr1, gcc_options *ptr2)
{
  ...
  if (ptr1->x_flag_lto_dump_list != ptr2->x_flag_lto_dump_list)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_abi != ptr2->x_mips_abi)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_abs != ptr2->x_mips_abs)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_android != ptr2->x_flag_android)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_arch_option != ptr2->x_mips_arch_option)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_linux_libc != ptr2->x_linux_libc)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_branch_cost != ptr2->x_mips_branch_cost)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_code_readable != ptr2->x_mips_code_readable)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_cb != ptr2->x_mips_cb)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_CRC != ptr2->x_TARGET_CRC)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_DEBUG_MODE != ptr2->x_TARGET_DEBUG_MODE)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_DEBUG_D_MODE != ptr2->x_TARGET_DEBUG_D_MODE)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_MDMX != ptr2->x_TARGET_MDMX)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_DSP != ptr2->x_TARGET_DSP)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_DSPR2 != ptr2->x_TARGET_DSPR2)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_EMBEDDED_DATA != ptr2->x_TARGET_EMBEDDED_DATA)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_EVA != ptr2->x_TARGET_EVA)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_EXTERN_SDATA != ptr2->x_TARGET_EXTERN_SDATA)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FIX_24K != ptr2->x_TARGET_FIX_24K)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FIX_RM7000 != ptr2->x_TARGET_FIX_RM7000)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FIX_SB1 != ptr2->x_TARGET_FIX_SB1)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FIX_VR4120 != ptr2->x_TARGET_FIX_VR4120)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FIX_VR4130 != ptr2->x_TARGET_FIX_VR4130)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_4300_MUL_FIX != ptr2->x_TARGET_4300_MUL_FIX)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FLIP_MIPS16 != ptr2->x_TARGET_FLIP_MIPS16)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_cache_flush_func != ptr2->x_mips_cache_flush_func)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FP_EXCEPTIONS != ptr2->x_TARGET_FP_EXCEPTIONS)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_frame_header_optimization != ptr2->x_flag_frame_header_optimization)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_GINV != ptr2->x_TARGET_GINV)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_GPOPT != ptr2->x_TARGET_GPOPT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_INTERLINK_COMPRESSED != ptr2->x_TARGET_INTERLINK_COMPRESSED)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_isa_option != ptr2->x_mips_isa_option)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_MIPS3D != ptr2->x_TARGET_MIPS3D)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_LOAD_STORE_PAIRS != ptr2->x_TARGET_LOAD_STORE_PAIRS)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_LOCAL_SDATA != ptr2->x_TARGET_LOCAL_SDATA)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_LONG_CALLS != ptr2->x_TARGET_LONG_CALLS)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_LOONGSON_EXT2 != ptr2->x_TARGET_LOONGSON_EXT2)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_lra_flag != ptr2->x_mips_lra_flag)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_lxc1_sxc1 != ptr2->x_mips_lxc1_sxc1)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_MAD != ptr2->x_TARGET_MAD)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_madd4 != ptr2->x_mips_madd4)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_MCOUNT_RA_ADDRESS != ptr2->x_TARGET_MCOUNT_RA_ADDRESS)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_MCU != ptr2->x_TARGET_MCU)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_MT != ptr2->x_TARGET_MT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_nan != ptr2->x_mips_nan)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_NO_FLOAT != ptr2->x_TARGET_NO_FLOAT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_PLT != ptr2->x_TARGET_PLT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_r10k_cache_barrier != ptr2->x_mips_r10k_cache_barrier)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_SHARED != ptr2->x_TARGET_SHARED)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_SYM32 != ptr2->x_TARGET_SYM32)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_mips_tune_option != ptr2->x_mips_tune_option)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_UNALIGNED_ACCESS != ptr2->x_TARGET_UNALIGNED_ACCESS)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_UNINIT_CONST_IN_RODATA != ptr2->x_TARGET_UNINIT_CONST_IN_RODATA)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_VIRT != ptr2->x_TARGET_VIRT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_XGOT != ptr2->x_TARGET_XGOT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_XPA != ptr2->x_TARGET_XPA)
    internal_error ("%<global_options%> are modified in local context");
