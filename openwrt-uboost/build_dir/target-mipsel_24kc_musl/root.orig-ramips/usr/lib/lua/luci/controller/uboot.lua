...
function action_status()
    ...
    -- Проверяем статусы сервисов (ИСПРАВЛЕНО: правильные вызовы)
...
function action_verify_otp()
    ...
    if result and result ~= "" then
        ...
        if response.error then
            ...
            -- Регистрация успешна - включаем DPI (ИСПРАВЛЕНО: правильный вызов)
...
function action_enable_dpi()
    ...
    -- Включаем DPI через скрипт (ИСПРАВЛЕНО: правильный вызов)
