...
BEGIN {
    ...
    require '/home/notlean/openwrt-uboost/build_dir/target-mipsel_24kc_musl/openssl-3.0.13/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/notlean/openwrt-uboost/build_dir/target-mipsel_24kc_musl/openssl-3.0.13/test/fips-and-base.cnf';
    shift;
