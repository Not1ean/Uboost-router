...
.ascii "->TI_REGS 20 offsetof(struct thread_info, regs)"	 #
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:101: 	DEFINE(_THREAD_SIZE, THREAD_SIZE);
 # 101 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->_THREAD_SIZE 8192 THREAD_SIZE"	 #
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:102: 	DEFINE(_THREAD_MASK, THREAD_MASK);
 # 102 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->_THREAD_MASK 8191 THREAD_MASK"	 #
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:103: 	DEFINE(_IRQ_STACK_SIZE, IRQ_STACK_SIZE);
 # 103 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->_IRQ_STACK_SIZE 8192 IRQ_STACK_SIZE"	 #
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:104: 	DEFINE(_IRQ_STACK_START, IRQ_STACK_START);
 # 104 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->_IRQ_STACK_START 8176 IRQ_STACK_START"	 #
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:105: 	BLANK();
 # 105 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->"
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:106: }
#NO_APP
	jr	$31	 #
...
.ascii "->"
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:212: 	DEFINE(_PAGE_SHIFT, PAGE_SHIFT);
 # 212 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->_PAGE_SHIFT 12 PAGE_SHIFT"	 #
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:213: 	DEFINE(_PAGE_SIZE, PAGE_SIZE);
 # 213 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->_PAGE_SIZE 4096 PAGE_SIZE"	 #
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:214: 	BLANK();
 # 214 "arch/mips/kernel/asm-offsets.c" 1
	
.ascii "->"
 # 0 "" 2
 # arch/mips/kernel/asm-offsets.c:215: }
#NO_APP
	jr	$31	 #
