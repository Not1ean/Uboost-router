...
#define HAVE_INIT_DEFERRABLE_WORK
#define HAVE_SYSTEM_POWER_EFFICIENT_WQ
...
#define HAVE_KVCALLOC
#define HAVE_KVFREE
#define HAVE_BITMAP_ZALLOC
#define HAVE_BITMAP_ZERO
...
#undef HAVE_PASSING_EXTENDED_ACK_TO_CALLBACKS
#undef HAVE_TYPEDEF_SCTP_SCTPHDR_T
#define HAVE_TIMER_SETUP
#define HAVE_STRSCPY
#undef HAVE_SYNCHRONIZE_RCU_BH
#define HAVE_LOCKDEP_NFNL_IS_HELD
#define HAVE_COND_RESCHED_RCU
#define HAVE_SKB_IIF
#define HAVE_LIST_FOR_EACH_ENTRY_RCU_FOUR_ARGS
#define HAVE_SKB_PROTOCOL
#define HAVE_NLA_POLICY_EXACT_LEN
#define HAVE_KVZALLOC
#define HAVE_GFP_KERNEL_ACCOUNT
#define HAVE_NLA_STRSCPY
#define HAVE_NFNL_MSG_PUT
#define HAVE_NFNL_INFO_IN_NFNL_CALLBACK
#define HAVE_NFNL_CALLBACK_TYPE
#define HAVE_EAGAIN_IN_NFNETLINK_UNICAST
#define HAVE_NLMSG_UNICAST
