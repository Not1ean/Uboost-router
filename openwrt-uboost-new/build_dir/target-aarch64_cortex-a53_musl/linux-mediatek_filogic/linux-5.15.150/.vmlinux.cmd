cmd_vmlinux := bash scripts/link-vmlinux.sh "aarch64-openwrt-linux-musl-ld" "-EL  -maarch64elf -z noexecstack --no-warn-rwx-segments" "--no-undefined -X --fix-cortex-a53-843419 --build-id=sha1  -X --orphan-handling=warn";  true
